...
// Add here your custom message. Twitter account, name, website, etc. (you don't need to do it but it looks cool)
// CREATED BY XYZ - SEND IT! - WE ARE THE CHAMPIONS
// CA: (I copied the contract address on after manually creating the contract on the theta explorer)
// Leave the rest of the contract intact.
